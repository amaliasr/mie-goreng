              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Hi, Admin!</h1>
                  </div>
                  <form action="<?=site_url('minminlog/DoLogin');?>" method="POST" role="form" class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="" placeholder="Username" name="username">
                    </div>
                    <div class="form-group">
