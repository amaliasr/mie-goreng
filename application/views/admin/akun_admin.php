            ...
            <table class="table table-bordered" id="dataTable" style="font-size: 12px">
              ...
              <tbody id="show_data">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?=site_url('pausbiru/visible_akun_admin/'.$key->id_admin)?>"><button type="button" class="btn btn-light btn-sm">
                      <?php if ($key->visible == '') {?>
                        <i class="fa fa-eye"></i>
                      <?php }else{ ?>
                  ...
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="<?=site_url('pausbiru/ubah_akun_admin/'.$key->id_admin)?>" method="POST" role="form" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="modalhapus<?=$key->id_admin?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <a href="<?=site_url('pausbiru/hapus_akun_admin/'.$key->id_admin)?>"><button type="button" class="btn btn-primary">Ya, Saya Yakin</button></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form action="<?=site_url('pausbiru/tambah_akun_admin')?>" method="POST" role="form" enctype="multipart/form-data">
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="inputPassword4">Expo</label>
                              <select name="id_actor" id="inputId_actor" class="form-control" required="required">
